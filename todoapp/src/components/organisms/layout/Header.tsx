...
export const Header:VFC=memo(()=>{
    ...
    return (
        ...
        <MenuDrawer onClose={onClose} isOpen={isOpen} onClickHome={onClickHome} onClickManagement={onClickUserManagement} onClickSetting={onClickSetting} onClickLogOut={onClickLogOut}/>
        </>
    )
});